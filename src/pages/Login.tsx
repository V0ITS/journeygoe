...
const Login = () => {
  ...
  return (
    <div className="min-h-screen travel-gradient flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 card-travel animate-fade-in">
        <div className="flex flex-col items-center mb-8">
          <div className="bg-primary text-primary-foreground p-4 rounded-full mb-4">
            <Plane size={40} />
          </div>
          <h1 className="text-3xl font-bold text-primary">JourneyGo</h1>
          <p className="text-muted-foreground text-center mt-2">
            AI Smart Travel Planner & Budget Assistant
          </p>
        </div>
